      ...
      <div className="bg-custom-blue">
        <div className='flex flex-row justify-center flex-wrap gap-8 pt-10 mt-10'>
          <div className="flex-1" >
            <img className="mb-4 mt-4" style={{display: "block", marginLeft: "auto", marginRight: "auto"}} src="./audio.png" alt=""/>
          ...
          <div className="flex-1" >
            <img className="mb-4 mt-4" style={{display: "block", marginLeft: "auto", marginRight: "auto"}} src="./Subscribe.png" alt=""/>
          ...
          <div className="flex-1" >
            <img className="mb-4 mt-4" style={{display: "block", marginLeft: "auto", marginRight: "auto"}} src="./PDF.png" alt=""/>
